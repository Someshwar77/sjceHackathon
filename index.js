...
function search(){
    ...
    if(option.value=='Ariyalur'){
        ariyalur.style.display="block";
    }
    else if(option.value=='Chennai'){
        chennai.style.display="block";
    }
    else if(option.value=='Chengalpattu'){
        chengalpattu.style.display="block";
    }
    else if(option.value=='Coimbatore'){
        coimbatore.style.display="block";
    }
    else if(option.value=='Cuddalore'){
        cuddalore.style.display="block";
    }
    else if(option.value=='Dharmapuri'){
        dharmapuri.style.display="block";
    }
    else if(option.value=="Erode"){
        erode.style.display="block";
    }
    else if(option.value=='Dindigul'){
        dindigul.style.display="block";
    }
    else if(option.value=='Kallakurichi'){
        kallakurichi.style.display="block";
    }
    else if(option.value=='Kanchipuram'){
        kanchipuram.style.display="block";
    }
    else if(option.value=="Karur"){
        karur.style.display="block";
    }
    else if(option.value=='Kanyakumari'){
        kanyakumari.style.display="block";
    }
    else if(option.value=='Krishnagiri'){
        krishnagiri.style.display="block";
    }
    else if(option.value=='Madurai'){
        madurai.style.display="block";
    }
    else if(option.value=='Nagapattinam'){
        nagapattinam.style.display="block";
    }
    else if(option.value=='Namakkal'){
        namakkal.style.display="block";
    }
    else if(option.value=='Nilgiris'){
        nilgiris.style.display="block";
    }
    else if(option.value=='Perambalur'){
        perambalur.style.display="block";
    }
    else if(option.value=='Pudukkottai'){
        pudukkottai.style.display="block";
    }
    else if(option.value=='Ramanathapuram'){
        ramanathapuram.style.display="block";
    }
    else if(option.value=="Salem"){
        salem.style.display="block";
    }
    else if(option.value=='Sivaganga'){
        sivaganga.style.display="block";
    }
    else if(option.value=='Tenkasi'){
        tenkasi.style.display="block";
    }
    else if(option.value=='Thanjavur'){
        thanjavur.style.display="block";
    }
    else if(option.value=='Thoothukudi'){
        thoothukudi.style.display="block";
    }
    else if(option.value=='Tiruchirappalli'){
        tiruchirappalli.style.display="block";
    }
    else if(option.value=='Tirunelveli'){
        tirunelveli.style.display="block";
    }
    else if(option.value=='Tirupathur'){
        tirupathur.style.display="block";
    }
    else if(option.value=='Tiruppur'){
        tiruppur.style.display="block";
    }
    else if(option.value=='Tiruvallur'){
        tiruvallur.style.display="block";
    }
    else if(option.value=='Tiruvannamalai'){
    ...
    else if(option.value=='Viluppuram'){
        viluppuram.style.display="block";
    }
    else if(option.value=='Virudhunagar'){
